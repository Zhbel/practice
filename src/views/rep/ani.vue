    ...
    <body>
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <p>Другие виды работ по НИР аспиранта:</p>
    ...
    methods: {
      ...
      createDoc(){
           ...
           const paragraph1 = new Paragraph({
                  ...
                  new TextRun( {
                  text: "ОТЧЕТ О НАУЧНО-ИССЛЕДОВАТЕЛЬСКОЙ ДЕЯТЕЛЬНОСТИ И",
                  bold: true,
                  size: 24,
                  }),

                  new TextRun( {
                  text: "ПОДГОТОВКЕ НАУЧНО-КВАЛИФИКАЦИОННОЙ РАБОТЫ (ДИССЕРТАЦИИ)",
                  bold: true,
                  size: 24,
                  break: 1,
                  }),
                  ...
                  new TextRun( {
                  text: "НА СОИСКАНИЕ УЧЕНОЙ СТЕПЕНИ КАНДИДАТА НАУК",
                  bold: true,
                  size: 24,
                  break: 1,
                  }),
                 ...
                 // console.log(this.report.workbefore)
                  ...
                  const otherh = new TextRun({
                    text: '4 Другие виды работ по НИР аспиранта',
                    break: 2
                  });
